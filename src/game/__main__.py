...
class Game():
    ...
    def run_game():
        ...
        # Bar surface
        bar_surface = pygame.Surface((Game.bar_length, Game.bar_thickness), pygame.SRCALPHA)
        bar_surface.fill(Game.WHITE)
        ...
        while running:
            ...
            tau_net = (Game.wL - Game.wR) * Game.g * Game.R
        
            # Add the torque from the perpendicular force
            tau_perpendicular = applied_force * Game.r_force
            tau_total = tau_net + tau_perpendicular
            
            # Update angular acceleration
            alpha = tau_total / Game.I_total
            ...
            rotated_rect, rotated_bar = Game.rotate_around_point(window, bar_surface, Game.theta, Game.pivot_point)
